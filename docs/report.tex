...
Por último, el proyecto se encuentra disponible en el repositorio de GitHub \url{https://github.com/smaje99/multi-agents-systems-and-computational-perception-unir}. Además, junto con el envío de este documento se adjunta un archivo comprimido con todo el proyecto para facilitar su revisión y verificación.
